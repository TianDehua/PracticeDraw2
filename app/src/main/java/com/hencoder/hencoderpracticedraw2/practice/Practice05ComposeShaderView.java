...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader logoShader = new BitmapShader(logoBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);

        Shader shader = new ComposeShader(batmanShader, logoShader, new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
